...
global $options_mlInt;
	...
	foreach ($data['results'] as $item) {
		...
		$output_temp.=  '<a rel="nofollow" href="http://pmstrk.mercadolibre.com.ar/jm/PmsTrk?tool=4272163137252252&go='.$permalink.'" title="'.$title.'" rel="nofollow" class="img-shadow" target="_blank"><img style="width:90%" src="'.$image.'" alt="'.$title.': '.$subtitle.'"/></a>';
